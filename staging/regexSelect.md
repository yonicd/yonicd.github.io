...
<a class="github-button" href="https://github.com/yonicd/regexSelect/issues" data-show-count="true" aria-label="Issue yonicd/regexSelect on GitHub">Issue</a> | [![CRAN\_Status\_Badge](https://www.r-pkg.org/badges/version/regexSelect?color=blue)](https://cran.r-project.org/package=regexSelect)![downloads](https://cranlogs.r-pkg.org/badges/grand-total/regexSelect)
